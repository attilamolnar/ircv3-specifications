...
The server MUST allow a client subscribe to any valid keys, even to privileged
keys when the client has no privilege to access that key at the time of the
subscription.
